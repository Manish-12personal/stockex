/**
 * Must stay in sync with server/utils/walletLedgerGameFilter.js WALLET_LEDGER_GAME_OPTIONS
 * (GameSettings keys + display labels for wallet ledger GAME_PROFIT filter).
 */
